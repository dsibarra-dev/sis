                    ...
                    <fieldset class="border-bottom">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="department" id="department" value="<?= isset($department) ? $department : "" ?>" class="form-control form-control-sm rounded-0" required>
                                    <option <?= isset($department) && $department == '7' ? 'selected' : '' ?>>BSIT</option>
                                    <option <?= isset($department) && $department == '8' ? 'selected' : '' ?>>BEED</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
