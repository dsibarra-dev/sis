                    ...
                    <table class="table table-stripped table-bordered" id="academic-history">
                        ...
                        <thead>
                            <tr class="bg-gradient-dark">
                                ...
                                <th class="py-1 text-center">Department/Course Code</th>
                                <th class="py-1 text-center">Yr/Semester</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-1 align-middle">
                                    <span class=""><?= $row['department'] ?> - <?= $row['course'] ?></span>
                                </td>
                                <td class="px-2 py-1 align-middle">
                                    <span class=""><?= $row['year'] ?> / <?= $row['semester'] ?></span>
                                </td>
                                <td class="px-2 py-1 align-middle"><?= $row['school_year'] ?></td>
<!--                                 <td class="px-2 py-1 align-middle text-center">
                                ...
                                <td class="px-2 py-1 align-middle text-center"><?= $row['grade'] ?></td>
                                <td class="px-2 py-1 align-middle text-center">
                                <?php 
                                    switch($row['end_status']){
                                        ...
                                        case '4':
                                            ...
                                            break;
                                        case '5':
                                            echo '<span class="rounded-pill badge badge-default bg-gradient-gray text-dark px-3">Not Enrolled</span>';
                                            break;
                                        default:
                                            echo '<span class="rounded-pill badge badge-default border px-3">N/A</span>';
                                            break;
